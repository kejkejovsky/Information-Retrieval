...
public class Indexer
{
    ...
    private void indexDocuments()
    {
        ...
        try {
            FSDirectory directory = FSDirectory.open(Paths.get(Constants.index_dir));
    ...
    private Document getHTMLDocument(String path, int id)
    {
        ...
        */
        ...
        // ----------------------------------
        IntPoint intSizeField = new IntPoint(Constants.filesize_int, (int) file.length());
        // ----------------------------------
        // //TODO IntPoint is not stored but we want to a file size
        // ... so add another field (StoredField) that stores file size
        // ----------------------------------
        StoredField sizeField = new StoredField(Constants.filesize, file.length());
        // ----------------------------------
